...
def add_data():
    ...
    book.append(models.Book.objects.create(title='Todas estas cosas que te diré mañana', author=author[1], publish_date='2022-07-19'))
    
    saga_ruina = models.BookSaga.objects.create(name='Ruina', author=author[2])
    book.append(models.Book.objects.create(title='Alianza', author=author[2], publish_date='2022-07-19', saga = saga_ruina))
    book.append(models.Book.objects.create(title='Venganza', author=author[2], publish_date='2022-07-19', saga = saga_ruina))
    book.append(models.Book.objects.create(title='Ruina', author=author[2], publish_date='2022-07-19', saga = saga_ruina))
    
    saga_la_villa_de_las_telas = models.BookSaga.objects.create(name='La villa de las telas', author=author[3])
    book.append(models.Book.objects.create(title='La villa de las telas', author=author[3], publish_date='2022-07-19', saga = saga_la_villa_de_las_telas))
    book.append(models.Book.objects.create(title='Las hijas de la villa de las telas', author=author[3], publish_date='2022-07-19', saga = saga_la_villa_de_las_telas))
    book.append(models.Book.objects.create(title='El legado de la villa de las telas', author=author[3], publish_date='2022-07-19', saga = saga_la_villa_de_las_telas ))
    book.append(models.Book.objects.create(title='Regreso a la villa de las telas', author=author[3], publish_date='2022-07-19', saga = saga_la_villa_de_las_telas))
    book.append(models.Book.objects.create(title='Tormenta en la villa de las telas', author=author[3], publish_date='2022-07-19', saga = saga_la_villa_de_las_telas))
    book.append(models.Book.objects.create(title='Reencuentro en la villa de las telas', author=author[3], publish_date='2022-07-19', saga = saga_la_villa_de_las_telas))
    ...
    book.append(models.Book.objects.create(title='La resistencia', author=author[5], publish_date='2022-07-19', language = language_spanish, saga = saga_memorias_de_idhun))
    book.append(models.Book.objects.create(title='Tríada', author=author[5], publish_date='2022-07-19', language = language_spanish, saga = saga_memorias_de_idhun))
    book.append(models.Book.objects.create(title='Panteón', author=author[5], publish_date='2022-07-19', language = language_spanish, saga = saga_memorias_de_idhun))
