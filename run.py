...
def add_data():
    print("Creating data...")
    genre_romance = book_catalog_models.Genre.objects.get(name="Romance")
    genre_fiction = book_catalog_models.Genre.objects.get(name="Fiction")
    genre_contemporary = book_catalog_models.Genre.objects.get(name="Contemporary")
    genre_adult = book_catalog_models.Genre.objects.get(name="Adult")
    language_french = book_catalog_models.Language.objects.get(name="French")
    language_english = book_catalog_models.Language.objects.get(name="English")
    language_german = book_catalog_models.Language.objects.get(name="German")
    language_italian = book_catalog_models.Language.objects.get(name="Italian")
    language_spanish = book_catalog_models.Language.objects.get(name="Spanish")
    ...
    book.append(book_catalog_models.Book.objects.create(title='Panteón', author=author[5], publish_date='2022-07-19',language = language_spanish, saga = saga_memorias_de_idhun, saga_volume = 3,
                                                        cover_image='covers/panteon-laura_gallego.jpeg'))
...
if __name__ == '__main__':
    ...
    parser.add_argument('command', choices=['add_data', 'clear_data','add_users'])
